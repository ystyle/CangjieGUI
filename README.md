...
- 提供按钮、复选框、开关、单选项、选择器、步进器、滑块、进度条、列表、标签页和文本输入等控件。
...
| `process_manager` | 后台任务、互斥邮箱、异常兜底、标签页和系统信息 |
| `focus_planner` | 局部状态、派生进度文本、文本换行、滚动与桌面控件 |
| `kanban_board` | 单一数据源看板、派生计数、ForEach 列表身份与筛选 |
